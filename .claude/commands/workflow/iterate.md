...
```bash
/iterate BRAINSTORM_CHECKOUT.md "Consider batch processing instead of real-time"
/iterate DEFINE_CHECKOUT.md "Add support for PDF invoices, not just TIFF"
/iterate DESIGN_CHECKOUT.md "Functions need to be self-contained, no shared common/"
