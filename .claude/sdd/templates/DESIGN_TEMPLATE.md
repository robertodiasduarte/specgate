...
|-------|----------------|----------------|
| @{agent-1} | 1, 3 | {Specialization match: e.g., "serverless deploy patterns"} |
| @{agent-2} | 2 | {Specialization match: e.g., "schema validation + typed output"} |
...
|--------|----------------|
| Logging | {Approach: e.g., "Structured JSON to the log aggregator"} |
| Metrics | {Approach: e.g., "Custom metrics via the monitoring backend"} |
